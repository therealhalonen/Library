...
public class BookStoreRestControllerTests {
	...
	public void testCreateCategory() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/api/categories").content("{\"name\": \"Test Category\"}")
	...
	public void testGetAllBooks() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/api/books")).andExpect(MockMvcResultMatchers.status().isOk());
	}
	...
	public void testAddAndUpdateBook() throws Exception {
		...
		MvcResult result = mockMvc
				.perform(MockMvcRequestBuilders.post("/api/books")
						.content("{\"title\": \"Test Book\"," + "\"author\": \"Test Author\","
								+ "\"publicationYear\": 2022," + "\"isbn\": \"1234567890123\"," + "\"price\": 150.0,"
		...
		mockMvc.perform(MockMvcRequestBuilders.put("/api/books/{id}", bookId)
				.content("{\"title\": \"Updated Book Title\"," + "\"author\": \"Updated Author\","
						+ "\"publicationYear\": 2023," + "\"isbn\": \"9876543210987\"," + "\"price\": 200.0,"
